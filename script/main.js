...
if (!isInIFrame) {
  var jsData = [
    "showcase-cta",
    "https://websitedemos.net/public-speaker-02/wp-content/plugins/astra-sites-server/admin/showcase-cta/switcher/dist/style-main.css?ver=f24aec05300c16fc666f",
  ];
  ...
  window._wpemojiSettings = {
    ...
    source: {
      concatemoji:
        "https://websitedemos.net/public-speaker-02/wp-includes/js/wp-emoji-release.min.js?ver=6.1.1",
    },
  };
